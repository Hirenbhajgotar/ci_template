...
$route['users/update-profile'] = 'users/update_user';
...
$route['administrator/users-role'] = 'administrator/role';
$route['administrator/users-permision'] = 'administrator/permision';
$route['administrator/update-permision/(:any)'] = 'administrator/update_permision/$1';
