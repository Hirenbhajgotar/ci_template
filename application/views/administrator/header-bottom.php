...
<div class="main-menu">
    ...
    <div class="main-menu-content">
		...
		// exit;
                    ?>
                    <?php if(isset($this->permision->creat) && $this->permision->creat == 1) { ?>
                        <li><a href="<?php echo base_url(); ?>administrator/users/add-user">Add User</a></li>
                    <?php } ?>
                    <?php if (isset($this->permision->view) && $this->permision->view == 1) { ?>
                        <li><a href="<?php echo base_url(); ?>administrator/users/users">Users</a></li>
                    <?php } ?>
                    <?php if ($this->session->userdata('role') == -1) { ?>
                        <li><a href="<?php echo base_url(); ?>administrator/users-role">Add User Role</a></li>
                    <?php } ?>
                    <?php if($this->session->userdata('role') == -1) { ?>
                        <li><a href="<?php echo base_url(); ?>administrator/users-permision">User Permisions</a></li>
                    <?php } ?>
                </ul>
            </li>
            <li class="nav-item">
                ...
                <ul class="tree-1">
                    <li class="nav-sub-item"><a href="#">Blogs</a>
                        <ul class="tree-2">
                            ...
                            <?php } ?>
                            <?php if (isset($this->permision->creat) && $this->permision->view == 1) { ?>
