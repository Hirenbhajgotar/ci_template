                                                 ...
                                                 <div class="col-lg-2 col-sm-3">
                                                     <div class="thumbnail">
                                                         <div class="thumb">
                                                             ...
                                                             <div class="img-upper">
                                                                 <a class="label label-inverse-danger delete" href='<?php echo base_url(); ?>administrator/delete/<?php echo $postImg['id']; ?>?table=<?php echo base64_encode('galleries'); ?>'><i class="icofont icofont-ui-delete"></i></a>
                                                             </div>
                                                             <?php } ?>
                                                         </div>
                                                     </div>
