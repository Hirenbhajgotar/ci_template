                   ...
                   <div class="card-block">
                       ...
                       <div class="col-sm-8">
                           ...
                           <div class="form-group row">
                               ...
                               <div class="col-sm-10">
                                   <select name="role_id" id="role_id" class="form-control">
                                       ...
                                       <?php foreach ($this->Administrator_Model->get_user_role() as $role) { ?>
                           ...
                           <div class="form-group row">
                               ...
                               <div class="col-sm-10">
                                   <input type="text" name="name" id="fname" onchange="setUserName()" class="form-control" placeholder="Full Name">
                               </div>
                           </div>
                           <div class="form-group row">
